...
************************************************************************
      ...
      PARAMETER (NFL=22,NPROB=74,NPAR=25)
      ...
      INTEGER CFLAG(5),NFLAG,UNCERTFLAG,ITRY,SFFLAG
      ...
      DOUBLE PRECISION PI,ALP1,ALP2,M32,CGR,MPL
...
*   Computation of neutralino masses
      ...
      CALL NEUTRALINO(PAR)
      IF(NFLAG.EQ.1)THEN
       PROB(74)=DDIM(DABS(MNEU(1))/MSL1,1d0)
       PROB(74)=PROB(74)+DDIM(DABS(MNEU(1))/MLR,1d0)
      ELSEIF(NFLAG.EQ.2)THEN
       PROB(74)=DDIM(MSL1/DABS(MNEU(1)),1d0)
       PROB(74)=PROB(74)+DDIM(MSL1/MLR,1d0)
      ELSEIF(NFLAG.EQ.3)THEN
       PROB(74)=DDIM(MLR/DABS(MNEU(1)),1d0)
       PROB(74)=PROB(74)+DDIM(MLR/MSL1,1d0)
      ENDIF
...
*********************************************************************
      ...
      INTEGER IFAIL,GMFLAG,I,J,NRES,IRES,NBIN,NSUSY,NGUT,NMES,IMAX
      ...
      DOUBLE PRECISION LPPMES,LTTMES,LUMES,LDMES,LTMES,LBMES,LLMES,XIU
      DOUBLE PRECISION LPPGUT,LTTGUT,LUGUT,LDGUT,LTGUT,LBGUT,LLGUT
      DOUBLE PRECISION SIGMU,MGUT,MINS,MINH
...
*********************************************************************
     ...
     . LDN,LDNN,LTN,LTNN,LBN,LBNN,LLN,LLNN,MUN,MUNN
      ...
      WRITE(0,10)"Version number: 5.4.1                    "
      WRITE(0,*)
      WRITE(0,*)
