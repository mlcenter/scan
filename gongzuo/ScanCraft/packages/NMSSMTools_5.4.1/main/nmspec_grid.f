...
************************************************************************
      ...
      PARAMETER (NFL=17,NPROB=73,NPAR=25)
      ...
      INTEGER HFLAG,NMSFLAG,CFLAG(5),UNCERTFLAG
...
*   Exp. constraints on sparticles (LHC)
      ...
      IF(CFLAG(5).EQ.1)CALL Higgsino_CMS_Trilep(PAR,PROB)
...
*********************************************************************
      ...
      INTEGER IFAIL,NBIN,I,J,NRES,IRES,NSUSY,NGUT,NMES,IMAX
