...
* HGG3(I,1): Higgs mass
* HGG3(I,2): upper on sigma[H_125]/sigma_SM*BR[H->2gamma] limit in pb
...
* Read the available Delta(M_charg-M_neut) from the grid:
 2700 READ(11,'(A13,17F13.0)',ERR=2) dum,(DmNeutmCharg(J),J=1,17)
