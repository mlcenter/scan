...
%{\color{green} one uses any other type of variable whose length is sufficient to store a computer address, for example {\it INTEGER*8}}
...
the vertical lines show the $3\sigma$ experimentally measured value.Numeri
}
\end{figure}
