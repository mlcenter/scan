...
printf("\n-I- Using Z' limits from dilepton final state with 3.2 fb-1 at sqrt(s) = 13 TeV\n");
printf("From http://arxiv.org/abs/1607.03669 (http://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PAPERS/EXOT-2015-07)\n");
printf("----------------------------------\n");
