      ...
      INTEGER K,L,INDA,INDPI,INDETA,INDETAP,INDEB1,MIXPROB,N0
...
C  * A -> gamma (Rho,omega->)Pi+Pi-
     ...
     .          *AEPRhogam+OMIX(INDA,4)*AARhogam
      GamARhogam=aux**2/(2d0**8*Pi**3*MA)*KinARhogam(MA)
...
*********************************************************************
      ...
      implicit none
      double precision MA1,MPI0,MPIC,aux,f0,f1,f2,f3,f4,f5,f6,f7,f8
...
*********************************************************************
      ...
      implicit none
      double precision MA1,META,aux,f0,f1,f2,f3,f4,f5,f6,f7,f8
