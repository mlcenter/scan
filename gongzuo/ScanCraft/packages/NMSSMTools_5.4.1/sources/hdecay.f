...
* Loop over CP-even Higgs bosons
      ...
      DO I=1,3
       ...
       MT0= 3.D8
       ASH= ALPHAS(MAX(1d0,MH),2)
       MC0= 1d8
       MB0= 2d8
       AS3= ALPHAS(MAX(1d0,MH),2)
       MC0= MC
       AS4= ALPHAS(MAX(1d0,MH),2)
...
*  Running quark masses at MA
       ...
       MT0= 3.D8
       ASH= ALPHAS(MAX(1d0,MA),2)
       MC0= 1d8
       MB0= 2d8
       AS3= ALPHAS(MAX(1d0,MA),2)
       MC0= MC
       AS4= ALPHAS(MAX(1d0,MA),2)
       MB0= MBP
       MT0= MT
